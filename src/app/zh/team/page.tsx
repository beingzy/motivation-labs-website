...
export const metadata: Metadata = {
  title: "Motivation Team — 人机协作团队的运营系统",
  description: product.description,
  alternates: { canonical: "/zh/team", languages: { en: "/team", zh: "/zh/team" } },
  openGraph: {
    title: "Motivation Team — 人机协作团队的运营系统",
    description: product.description,
    type: "website",
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
            ...
            <div className="border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] bg-white p-6 md:p-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: d.dashboardLabels.onboarding, color: "bg-violet-400" },
                  { label: d.dashboardLabels.saasAudit, color: "bg-violet-300" },
                  { label: d.dashboardLabels.apiGovernance, color: "bg-violet-200" },
                  { label: d.dashboardLabels.agents, color: "bg-violet-100" },
                ].map((mod) => (
